...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Czw0aOsy.mjs");
...
var manifest = { "1be802d4e45142c356482c8ddb01d97320743710ccd34590d1c4d66749cf35cc": {
	functionName: "generateAndroidApp_createServerFn_handler",
	importer: () => import("./generate-CHQaZTFu.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CpSwuz11.mjs").then((n) => n.t),
