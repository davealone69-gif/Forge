...
var Route$2 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Build Android apps with a built-in AI. Describe what you want, preview it on a phone, and download a Jetpack Compose project. Free."
			},
			{
				name: "theme-color",
				content: "#0c0e0d"
		...
		links: [
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500&family=Outfit:wght@360;420;500;580;640&display=swap"
			}
		]
	}),
